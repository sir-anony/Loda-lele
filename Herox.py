    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 5:
            ...
            try:
                ...
                await event.edit("𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘 𝐂𝐇𝐀𝐍𝐆𝐄𝐃 𝐁𝐈𝐎")
            except Exception as e:
...
USTAD_PIC = "https://te.legra.ph/file/da853f68f9f96368582fc.jpg"
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit("🔥 ʜᴇʀᴏx ᴏᴘ 🔥.!\n`{ms}` ms\n ʜᴇʀᴏx sᴘᴀᴍʙᴏᴛ ɪs ᴀʟɪᴠᴇ️")
...
print(text)
print("")
print("🙏🔥🔥SMEX! HEROX sᴘᴀᴍ ʙᴏᴛ sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ.🔥🔥🙏")
